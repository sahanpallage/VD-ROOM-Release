                ...
                <div className=" py-3">
                  ...
                  <div className="d-flex flex-column gap-10 my-3">
                    ...
                    <p className="product-data">
                      ...
                      <br /> We ship all US domestic orders within 5-10 business
                      days!
                      <br />
                    </p>
                  </div>
          ...
          <div className="col-12">
            ...
            <div className="bg-white p-3">
              <p className="bg-white p-3">
                ...
                impedit perferendis odit quasi repellat placeat eius dicta
                consequuntur pariatur, earum suscipit omnis obcaecati commodi?
                Atque culpa cumque non dolore nemo.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="reviews mt-4">
                <div className="review">
                  ...
                  <p className="mt-3">
                    ...
                    Voluptatibus corporis veritatis nostrum explicabo nam eaque
                    officiis.
                  </p>
                </div>
              </div>
